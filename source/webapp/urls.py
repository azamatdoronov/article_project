...
urlpatterns = [
    ...
    path('article/<slug:slug>/update/', UpdateArticle.as_view(), name="update_article"),
    ...
    path('article/<int:article_pk>/comments/<int:comment_pk>/update/', UpdateComment.as_view(), name="update_comment"),
